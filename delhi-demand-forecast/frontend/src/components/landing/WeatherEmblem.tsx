/** Landing-page emblem: a deep night disc holding sun, storm cloud, lightning,
    ...
    >
      <defs>
        ...
        <linearGradient id="lp-cloud" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#a9b9d2" />
        </linearGradient>
        <linearGradient id="lp-cloud-shadow" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#6f829f" />
          <stop offset="100%" stopColor="#465873" />
        </linearGradient>
        <linearGradient id="lp-bolt" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#a6cbf7" />
      ...
      <g className="lp-orbit">
        <circle cx="200" cy="200" r="182" fill="none" stroke="#2f2f35" strokeWidth="0.8" strokeDasharray="3 9" />
        <circle cx="200" cy="18" r="2.6" fill="#8fc0f5" filter="url(#lp-glow)" />
        <circle cx="382" cy="200" r="1.8" fill="#9085e9" />
      </g>
      <g className="lp-orbit-rev">
        <circle cx="200" cy="200" r="168" fill="none" stroke="#2f2f35" strokeWidth="0.8" />
        <circle cx="32" cy="200" r="2.2" fill="#f5a623" filter="url(#lp-glow)" />
      </g>
      <path d="M40 120 L120 118" stroke="#2f2f35" strokeWidth="1" strokeLinecap="round" />
      <path d="M300 250 L360 262" stroke="#2f2f35" strokeWidth="1" strokeLinecap="round" />

      {/* disc */}
      <circle cx="200" cy="200" r="150" fill="url(#lp-disc)" stroke="#2f2f35" strokeWidth="1.5" />
      <circle cx="200" cy="200" r="150" fill="none" stroke="#3987e5" strokeOpacity="0.35" strokeWidth="6" filter="url(#lp-soft)" />
      <circle cx="200" cy="200" r="150" fill="none" stroke="#ffffff" strokeOpacity="0.06" strokeWidth="1" />
      ...
      <circle cx="262" cy="108" r="30" fill="none" stroke="#ffe08a" strokeOpacity="0.7" strokeWidth="1" />

      {/* thermometer */}
      <text x="322" y="98" fill="#8fc0f5" fontSize="12" fontWeight="600" fontFamily="JetBrains Mono, ui-monospace, monospace">{tempC != null ? `${Math.round(tempC)}°` : '–'}</text>
      <rect x="296" y="88" width="14" height="84" rx="7" fill="#18181b" stroke="#3b3b44" strokeWidth="1" />
      <rect x="296" y={fillY} width="14" height={tubeBottom - fillY + 10} fill="#3987e5" clipPath="url(#lp-tube)" />
      <circle cx="303" cy="178" r="11" fill="#3987e5" stroke="#3b3b44" strokeWidth="1" filter="url(#lp-glow)" />
      {[104, 122, 140, 158].map((y) => <line key={y} x1="311" y1={y} x2="317" y2={y} stroke="#3b3b44" strokeWidth="1" />)}

      {/* cloud */}
      <g className="lp-cloud">
        <g opacity="0.45" filter="url(#lp-soft)"><ellipse cx="190" cy="205" rx="78" ry="22" fill="#000000" /></g>
      ...
      {/* rain */}
      <g className="lp-rain" stroke="#5aa2f0" strokeWidth="2" strokeLinecap="round" strokeDasharray="8 16" opacity="0.8">
      ...
      {/* small satellites */}
      <circle cx="110" cy="248" r="5" fill="#3987e5" opacity="0.9" />
      <circle cx="290" cy="248" r="3" fill="#8fc0f5" />
    </svg>
  )
}
