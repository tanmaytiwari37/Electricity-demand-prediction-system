...
![PeakWatch landing page](docs/images/landing.png)
...
|---|---|
| ![Overview](docs/images/overview.png) | ![Forecast](docs/images/forecast.png) |

| Grid alerts | Area intelligence |
|---|---|
| ![Alerts](docs/images/alerts.png) | ![Areas](docs/images/areas.png) |

| Weather impact | Scenario simulator |
|---|---|
| ![Weather impact](docs/images/weather.png) | ![What-if scenario](docs/images/scenario.png) |

| Model intelligence |
|---|
| ![Model card](docs/images/model.png) |
...
If the clone put the project inside a parent folder, `cd` into the folder that contains
...
Endpoint behaviour and failure modes are described in [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
